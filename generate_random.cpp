...
int main()
{
    ...
    */
    ...
    answer = "The output is a sequence of 10 random numbers between 0 and 4" ; // 2. Write your answer to Q2 in between " "
    ...
    answer = "The output is a sequence of 10 random numbers between 3 and 7" ; // 3. Write your answer to Q3 in between " "
    ...
    answer = "When you remove srand(time(NULL)), the program generated the same sequence of numbers twice because you are using the same seed value" ; // 4. Write your answer to Q4 in between " "
